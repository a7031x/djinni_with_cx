...
@implementation RecordWithDerivings
...
{
    if (![other isKindOfClass:[RecordWithDerivings class]]) {
        return NO;
    }
    RecordWithDerivings *typedOther = (RecordWithDerivings *)other;
...
- (NSComparisonResult)compare:(RecordWithDerivings *)other
{
